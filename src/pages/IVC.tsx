...
import { Building2, UserCheck, Mail, Phone, ChevronRight, Sparkles, AlertCircle, Shield, FileText, GraduationCap } from "lucide-react";
                        ...
                        <div className="bg-white rounded-3xl shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {/* Officer/Adviser Name */}
                                    <div className="md:col-span-2 space-y-2">
                                        <label className="flex items-center gap-2 text-gray-700 font-medium">
                                            <UserCheck className="w-4 h-4" />
                                            Name of Department Officer / Course Adviser
                                        </label>
                                        <input
                                            type="text"
                                            name="institutionOfficer"
                                            value={formData.institutionOfficer}
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            e.g., Dr. John Doe - Head of Department, Computer Science
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        <p className="text-sm text-gray-500 mt-1">
                                            Must be an official institutional email address
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        <p className="text-sm text-gray-500 mt-1">
                                            Official department or office phone number
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        <span>Continue to Eligibility Verification</span>
                                ...
                                <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
                                    ...
                                    <div className="text-sm text-gray-500">
                                        Step 7 of 10 • Institutional Verification
                                    </div>
                                </div>
                            </div>
                        </div>
